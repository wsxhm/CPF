...
namespace CPF.Mac.Foundation
{
	...
	public class NSUrlResponse : NSObject
	{
			...
			: base(NSObjectFlag.Empty)
		{
			...
			IntPtr intPtr2 = NSString.CreateNative(textEncodingName);
			if (IsDirectBinding)
			{
				base.Handle = Messaging.IntPtr_objc_msgSend_IntPtr_IntPtr_Int64_IntPtr(base.Handle, selInitWithURLMIMETypeExpectedContentLengthTextEncodingName_Handle, url.Handle, intPtr, expectedContentLength, intPtr2);
			}
			else
			{
				base.Handle = Messaging.IntPtr_objc_msgSendSuper_IntPtr_IntPtr_Int64_IntPtr(base.SuperHandle, selInitWithURLMIMETypeExpectedContentLengthTextEncodingName_Handle, url.Handle, intPtr, expectedContentLength, intPtr2);
			}
