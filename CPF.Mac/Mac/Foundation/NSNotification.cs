...
namespace CPF.Mac.Foundation
{
	...
	public class NSNotification : NSObject
	{
		...
		public static NSNotification FromName(string name, NSObject obj)
		{
			...
			NSNotification result = (NSNotification)Runtime.GetNSObject(Messaging.IntPtr_objc_msgSend_IntPtr_IntPtr(class_ptr, selNotificationWithNameObject_Handle, intPtr, obj.Handle));
		...
		public static NSNotification FromName(string name, NSObject obj, NSDictionary userInfo)
		{
			...
			IntPtr intPtr = NSString.CreateNative(name);
			NSNotification result = (NSNotification)Runtime.GetNSObject(Messaging.IntPtr_objc_msgSend_IntPtr_IntPtr_IntPtr(class_ptr, selNotificationWithNameObjectUserInfo_Handle, intPtr, obj.Handle, userInfo.Handle));
			NSString.ReleaseNative(intPtr);
			return result;
		}
