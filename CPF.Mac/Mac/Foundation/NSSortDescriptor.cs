...
namespace CPF.Mac.Foundation
{
	...
	public class NSSortDescriptor : NSObject
	{
			...
			: base(NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding)
			{
				base.Handle = Messaging.IntPtr_objc_msgSend_IntPtr_bool(base.Handle, selInitWithKeyAscending_Handle, intPtr, ascending);
			}
			else
			{
				base.Handle = Messaging.IntPtr_objc_msgSendSuper_IntPtr_bool(base.SuperHandle, selInitWithKeyAscending_Handle, intPtr, ascending);
			}
			...
			: base(NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding)
			{
				base.Handle = Messaging.IntPtr_objc_msgSend_IntPtr_bool_IntPtr(base.Handle, selInitWithKeyAscendingSelector_Handle, intPtr, ascending, selector.Handle);
			}
			else
			{
				base.Handle = Messaging.IntPtr_objc_msgSendSuper_IntPtr_bool_IntPtr(base.SuperHandle, selInitWithKeyAscendingSelector_Handle, intPtr, ascending, selector.Handle);
			}
			NSString.ReleaseNative(intPtr);
		}
