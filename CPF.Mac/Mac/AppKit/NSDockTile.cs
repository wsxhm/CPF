	...
	public class NSDockTile : NSObject
	{
		...
		public virtual string BadgeLabel
		{
			...
			set
			{
				...
				if (IsDirectBinding)
				{
					Messaging.void_objc_msgSend_IntPtr(base.Handle, selSetBadgeLabel_Handle, intPtr);
				}
				else
				{
					Messaging.void_objc_msgSendSuper_IntPtr(base.SuperHandle, selSetBadgeLabel_Handle, intPtr);
				}
