	...
	public class NSEntityMapping : NSObject
	{
		...
		public virtual string SourceEntityName
		{
			...
			set
			{
				...
				if (IsDirectBinding)
				{
					Messaging.void_objc_msgSend_IntPtr(base.Handle, selSetSourceEntityName_Handle, intPtr);
				}
				else
				{
					Messaging.void_objc_msgSendSuper_IntPtr(base.SuperHandle, selSetSourceEntityName_Handle, intPtr);
				}
				NSString.ReleaseNative(intPtr);
			}
		}
		...
		public virtual string DestinationEntityName
		{
			...
			set
			{
				...
				if (IsDirectBinding)
				{
					Messaging.void_objc_msgSend_IntPtr(base.Handle, selSetDestinationEntityName_Handle, intPtr);
				}
				else
				{
					Messaging.void_objc_msgSendSuper_IntPtr(base.SuperHandle, selSetDestinationEntityName_Handle, intPtr);
				}
				NSString.ReleaseNative(intPtr);
			}
		}
		...
		public virtual string EntityMigrationPolicyClassName
		{
			...
			set
			{
				...
				if (IsDirectBinding)
				{
					Messaging.void_objc_msgSend_IntPtr(base.Handle, selSetEntityMigrationPolicyClassName_Handle, intPtr);
				}
				else
				{
					Messaging.void_objc_msgSendSuper_IntPtr(base.SuperHandle, selSetEntityMigrationPolicyClassName_Handle, intPtr);
				}
				NSString.ReleaseNative(intPtr);
			}
		}
