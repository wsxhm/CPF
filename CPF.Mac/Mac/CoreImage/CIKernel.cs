...
namespace CPF.Mac.CoreImage
{
	...
	public class CIKernel : NSObject
	{
		...
		public static CIKernel[] FromProgram(string coreImageShaderProgram)
		{
			...
			IntPtr intPtr = NSString.CreateNative(coreImageShaderProgram);
			CIKernel[] result = NSArray.ArrayFromHandle<CIKernel>(Messaging.IntPtr_objc_msgSend_IntPtr(class_ptr, selKernelsWithString_Handle, intPtr));
