...
using System.Text;
using CPF.Styling;
using CPF.Styling.TextBlocks;

// https://github.com/Unity-Technologies/ExCSS
using System;
...
namespace CPF.Styling
{
    ...
    public sealed partial class Parser
    {
        ...
        public StyleSheet Parse(string css, string url = null)
        {
            if (css == null)
            {
                css = "";
            ...
            _styleSheet = new StyleSheet { Url = url };
