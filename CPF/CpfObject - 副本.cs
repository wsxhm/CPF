...
namespace CPF
{
    ...
    /// </summary>
    public class CpfObject : INotifyPropertyChanged, IDisposable, ICloneable, Design.ISerializerCode, IObservable<EventObserver<EventArgs, CpfObject>>
    {
        static ConcurrentDictionary<Type, Dictionary<string, PropertyMetadataAttribute>> typeCache = new ConcurrentDictionary<Type, Dictionary<string, PropertyMetadataAttribute>>();
        ...
        static Dictionary<Type, List<MethodInfo>> propertyChangedMethods = new Dictionary<Type, List<MethodInfo>>();

        static KeyValuePair<Type, Dictionary<string, PropertyMetadataAttribute>>[] saveTypeCache;
        ...
        Dictionary<string, PropertyMetadataAttribute> objInfo;
        ...
        public CpfObject()
        {
            ...
            if (!typeCache.TryGetValue(type, out objInfo))
            {
                ...
                objInfo = new Dictionary<string, PropertyMetadataAttribute>();
        ...
        class TypeCompar : IComparer<Type>
        {
        ...
        {
            var func = new Attached<Value>((obj, value) =>
             {
        ...
        EffectiveValue GetEffectiveValue(PropertyMetadataAttribute attribute)
        {
        ...
        public virtual bool SetValue<T>(T value, [CallerMemberName] string propertyName = null)
        {
            ...
            if (OnSetValue(propertyName, ref v))
            {
                ...
                if (!oldValue.Equal(v))
                {
                    ...
                    {
                        OnSetValue(propertyName, p, ValueForm.Property, v);
        ...
        internal void SetStyleValue(string propertyName, Style style, object value)
        {
            if (OnSetValue(propertyName, ref value))
            {
                ...
                try
                {
                    if (oValue.styleValues == null || oValue.styleValues.Count == 0 || oValue.styleValues[oValue.styleValues.Count - 1].Style.Index < style.Index)
                    {
                        object oldValue;
        ...
        class StyleSort : IComparer<StyleValue>
        {
            public int Compare(StyleValue x, StyleValue y)
            {
                return x.Style.Index - y.Style.Index;
            }
        }
        ...
        internal void SetAnimationValue(string propertyName, Storyboard Storyboard, object value)
        {
            if (OnSetValue(propertyName, ref value))
            {
                ...
                if ((oldValue == null && value != null) || (oldValue != null && value == null) || (oldValue != null && !oldValue.Equals(value)))
                {
                    OnSetValue(propertyName, p, ValueForm.Animation, value);
                    OnPropertyChanged(propertyName, oldValue, value, p);
                }
            }
        }
        internal void SetTriggerValue(string propertyName, Trigger Trigger, object value)
        {
            if (OnSetValue(propertyName, ref value))
            {
                ...
                oValue.SetTriggerValue(Trigger, value);
                ...
                if ((oldValue == null && value != null) || (oldValue != null && value == null) || (oldValue != null && !oldValue.Equals(value)))
                {
                    OnSetValue(propertyName, p, ValueForm.Trigger, value);
                    OnPropertyChanged(propertyName, oldValue, value, p);
                }
            }
        }
        ...
        void RegisterRenderDataContext(object newValue, object oldValue, PropertyMetadataAttribute attribute)
        {
            if (oldValue != null)
            {
                if (bindings != null)
        ...
        static string strPropertyChanged = "PropertyChanged";
        ...
        public void ClearLocalValue(string propertyName)
        {
            ...
            if (TryGetValue(propertyName, out PropertyMetadataAttribute p, out v))
            {
                ...
                {
                    OnSetValue(propertyName, p, ValueForm.Property, newValue);
        ...
        internal virtual void ClearAnimationValue(Storyboard Storyboard, string propertyName)
        {
            ...
            if (TryGetValue(propertyName, out PropertyMetadataAttribute p, out value))
            {
                ...
                if (r)
                {
                    ...
                    {
                        OnSetValue(propertyName, p, ValueForm.Animation, newValue);
                        OnPropertyChanged(propertyName, oldValue, newValue, p);
                    }
                }
            }
        ...
        internal virtual void ClearTriggerValue(Trigger Trigger, string propertyName)
        {
            ...
            if (TryGetValue(propertyName, out PropertyMetadataAttribute p, out value))
            {
                ...
                if (r)
                {
                    ...
                    if (!isDisposing && ((oldValue != null && !oldValue.Equals(newValue)) || (oldValue == null && newValue != null)))
                    {
                        OnSetValue(propertyName, p, ValueForm.Trigger, newValue);
                        OnPropertyChanged(propertyName, oldValue, newValue, p);
                    }
                }
            }
        ...
        internal virtual void OnSetValue(string propertyName, PropertyMetadataAttribute property, ValueForm valueForm, object newValue)
        {
            ...
            foreach (var item in objInfo)
            {
                ...
                if (value.HasStyle(style))
                {
                    ...
                    if (r)
                    {
                        ...
                        if ((oldValue != null && !oldValue.Equals(newValue)) || (oldValue == null && newValue != null))
                        {
                            OnSetValue(item.Key, item.Value, ValueForm.Style, newValue);
    ...
    internal class EffectiveValue
    {
        ...
        public _List<StyleValue> styleValues;
        //public EffectiveValueEntry TemplateValue;
        public void SetStyleValue(Style style, object value)
        {
            if (styleValues == null)
            {
                styleValues = new _List<StyleValue>();
            }
            else
            {
                if (styleValues.Any(a => a.Style == style))
                {
                    return;
                }
            }
            styleValues.Add(new StyleValue { Style = style, Value = value });
        }

        public void SetTriggerValue(Trigger Trigger, object value)
        {
            if (TriggerValue == null)
            {
                TriggerValue = new _List<TriggerValue>();
            }
            TriggerValue.Add(new TriggerValue { Trigger = Trigger, Value = value });
        ...
        public bool ClearStyleValue(Style style)
        {
            if (styleValues != null)
            {
                var v = styleValues.FirstOrDefault(a => a.Style == style);
                if (v != null)
                {
        ...
        public bool HasStyle(Style style)
        {
            if (styleValues != null)
            {
                return styleValues.Any(a => a.Style == style);
            }
            return false;
        }
    ...
    public class CPFPropertyChangedEventArgs : EventArgs
    {
        ...
        public PropertyMetadataAttribute PropertyMetadata { get; set; }
    }
    ...
    class _List<T>
    {
        ...
        public _List<T> Clone()
        {
            ...
            list._items = new T[_size];
            if (_size > 0)
            {
                Array.Copy(_items, 0, list._items, 0, _size);
            }
            return list;
        }
