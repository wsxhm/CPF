...
namespace CPF.Linux
{
    static class X11KeyConvert
    {
        private static readonly Dictionary<X11Key, Keys> KeyDic = new Dictionary<X11Key, Keys>
        {
            {X11Key.Cancel, Keys.Cancel},
            {X11Key.BackSpace, Keys.Back},
            {X11Key.Tab, Keys.Tab},
            {X11Key.Linefeed, Keys.LineFeed},
            {X11Key.Clear, Keys.Clear},
            {X11Key.Return, Keys.Return},
            {X11Key.KP_Enter, Keys.Return},
            {X11Key.Pause, Keys.Pause},
            {X11Key.Caps_Lock, Keys.CapsLock},
            //{ X11Key.?, Keys.HangulMode }
            //{ X11Key.?, Keys.JunjaMode }
            //{ X11Key.?, Keys.FinalMode }
            //{ X11Key.?, Keys.KanjiMode }
            {X11Key.Escape, Keys.Escape},
            //{ X11Key.?, Keys.ImeConvert }
            //{ X11Key.?, Keys.ImeNonConvert }
            //{ X11Key.?, Keys.ImeAccept }
            //{ X11Key.?, Keys.ImeModeChange }
            {X11Key.space, Keys.Space},
            {X11Key.Prior, Keys.Prior},
            {X11Key.KP_Prior, Keys.Prior},
            {X11Key.Page_Down, Keys.PageDown},
            {X11Key.KP_Page_Down, Keys.PageDown},
            {X11Key.End, Keys.End},
            {X11Key.KP_End, Keys.End},
            {X11Key.Home, Keys.Home},
            {X11Key.KP_Home, Keys.Home},
            {X11Key.Left, Keys.Left},
            {X11Key.KP_Left, Keys.Left},
            {X11Key.Up, Keys.Up},
            {X11Key.KP_Up, Keys.Up},
            {X11Key.Right, Keys.Right},
            {X11Key.KP_Right, Keys.Right},
            {X11Key.Down, Keys.Down},
            {X11Key.KP_Down, Keys.Down},
            {X11Key.Select, Keys.Select},
            {X11Key.Print, Keys.Print},
            {X11Key.Execute, Keys.Execute},
            //{ X11Key.?, Keys.Snapshot }
            {X11Key.Insert, Keys.Insert},
            {X11Key.KP_Insert, Keys.Insert},
            {X11Key.Delete, Keys.Delete},
            {X11Key.KP_Delete, Keys.Delete},
            {X11Key.Help, Keys.Help},
            {X11Key.A, Keys.A},
            {X11Key.B, Keys.B},
            {X11Key.C, Keys.C},
            {X11Key.D, Keys.D},
            ...
            {X11Key.y, Keys.Y},
            {X11Key.z, Keys.Z},
            {X11Key.Super_L, Keys.LWin },
            {X11Key.Super_R, Keys.RWin },
            {X11Key.Menu, Keys.Apps},
            //{ X11Key.?, Keys.Sleep }
            {X11Key.KP_0, Keys.NumPad0},
            {X11Key.KP_1, Keys.NumPad1},
            {X11Key.KP_2, Keys.NumPad2},
            {X11Key.KP_3, Keys.NumPad3},
            {X11Key.KP_4, Keys.NumPad4},
            {X11Key.KP_5, Keys.NumPad5},
            {X11Key.KP_6, Keys.NumPad6},
            {X11Key.KP_7, Keys.NumPad7},
            {X11Key.KP_8, Keys.NumPad8},
            {X11Key.KP_9, Keys.NumPad9},
            {X11Key.multiply, Keys.Multiply},
            {X11Key.KP_Multiply, Keys.Multiply},
            {X11Key.KP_Add, Keys.Add},
            //{ X11Key.?, Keys.Separator }
            {X11Key.KP_Subtract, Keys.Subtract},
            {X11Key.KP_Decimal, Keys.Decimal},
            {X11Key.KP_Divide, Keys.Divide},
            {X11Key.F1, Keys.F1},
            {X11Key.F2, Keys.F2},
            {X11Key.F3, Keys.F3},
            {X11Key.F4, Keys.F4},
            ...
            {X11Key.F23, Keys.F23},
            {X11Key.R4, Keys.F24},
            {X11Key.Num_Lock, Keys.NumLock},
            {X11Key.Scroll_Lock, Keys.Scroll},
            {X11Key.Shift_L, Keys.LeftShift},
            {X11Key.Shift_R, Keys.RightShift},
            {X11Key.Control_L, Keys.LeftCtrl},
            {X11Key.Control_R, Keys.RightCtrl},
            {X11Key.Alt_L, Keys.LeftAlt},
            {X11Key.Alt_R, Keys.RightAlt},
            //{ X11Key.?, Keys.BrowserBack }
            //{ X11Key.?, Keys.BrowserForward }
            //{ X11Key.?, Keys.BrowserRefresh }
            //{ X11Key.?, Keys.BrowserStop }
            //{ X11Key.?, Keys.BrowserSearch }
            //{ X11Key.?, Keys.BrowserFavorites }
            //{ X11Key.?, Keys.BrowserHome }
            //{ X11Key.?, Keys.VolumeMute }
            //{ X11Key.?, Keys.VolumeDown }
            //{ X11Key.?, Keys.VolumeUp }
            //{ X11Key.?, Keys.MediaNextTrack }
            //{ X11Key.?, Keys.MediaPreviousTrack }
            //{ X11Key.?, Keys.MediaStop }
            //{ X11Key.?, Keys.MediaPlayPause }
            //{ X11Key.?, Keys.LaunchMail }
            //{ X11Key.?, Keys.SelectMedia }
            //{ X11Key.?, Keys.LaunchApplication1 }
            //{ X11Key.?, Keys.LaunchApplication2 }
            {X11Key.minus, Keys.OemMinus},
            {X11Key.underscore, Keys.OemMinus},
            {X11Key.plus, Keys.OemPlus},
            {X11Key.equal, Keys.OemPlus},
            {X11Key.bracketleft, Keys.OemOpenBrackets},
            {X11Key.braceleft, Keys.OemOpenBrackets},
            {X11Key.bracketright, Keys.OemCloseBrackets},
            {X11Key.braceright, Keys.OemCloseBrackets},
            {X11Key.backslash, Keys.OemPipe},
            {X11Key.bar, Keys.OemPipe},
            {X11Key.semicolon, Keys.OemSemicolon},
            {X11Key.colon, Keys.OemSemicolon},
            {X11Key.apostrophe, Keys.OemQuotes},
            {X11Key.quotedbl, Keys.OemQuotes},
            {X11Key.comma, Keys.OemComma},
            {X11Key.less, Keys.OemComma},
            {X11Key.period, Keys.OemPeriod},
            {X11Key.greater, Keys.OemPeriod},
            {X11Key.slash, Keys.Oem2},
            {X11Key.question, Keys.Oem2},
            {X11Key.grave, Keys.OemTilde},
            {X11Key.asciitilde, Keys.OemTilde},
            {X11Key.XK_1, Keys.D1},
            {X11Key.exclam, Keys.D1},
            {X11Key.XK_2, Keys.D2},
            {X11Key.at, Keys.D2},
            {X11Key.XK_3, Keys.D3},
            {X11Key.numbersign, Keys.D3},
            {X11Key.XK_4, Keys.D4},
            {X11Key.dollar, Keys.D4},
            {X11Key.XK_5, Keys.D5},
            {X11Key.percent, Keys.D5},
            {X11Key.XK_6, Keys.D6},
            {X11Key.asciicircum, Keys.D6},
            {X11Key.XK_7, Keys.D7},
            {X11Key.ampersand, Keys.D7},
            {X11Key.XK_8, Keys.D8},
            {X11Key.asterisk, Keys.D8},
            {X11Key.XK_9, Keys.D9},
            {X11Key.parenleft, Keys.D9},
            {X11Key.XK_0, Keys.D0},
            {X11Key.parenright, Keys.D0},

            //{ X11Key.?, Keys.AbntC1 }
            //{ X11Key.?, Keys.AbntC2 }
            //{ X11Key.?, Keys.Oem8 }
            //{ X11Key.?, Keys.Oem102 }
            //{ X11Key.?, Keys.ImeProcessed }
            //{ X11Key.?, Keys.System }
            //{ X11Key.?, Keys.OemAttn }
            //{ X11Key.?, Keys.OemFinish }
            //{ X11Key.?, Keys.DbeHiragana }
            //{ X11Key.?, Keys.OemAuto }
            //{ X11Key.?, Keys.DbeDbcsChar }
            //{ X11Key.?, Keys.OemBackTab }
            //{ X11Key.?, Keys.Attn }
            //{ X11Key.?, Keys.DbeEnterWordRegisterMode }
            //{ X11Key.?, Keys.DbeEnterImeConfigureMode }
            //{ X11Key.?, Keys.EraseEof }
            //{ X11Key.?, Keys.Play }
            //{ X11Key.?, Keys.Zoom }
            //{ X11Key.?, Keys.NoName }
            //{ X11Key.?, Keys.DbeEnterDialogConversionMode }
            //{ X11Key.?, Keys.OemClear }
            //{ X11Key.?, Keys.DeadCharProcessed }
        };

        public static Keys ConvertKey(X11Key key)
            => KeyDic.TryGetValue(key, out var result) ? result : Keys.None;
    }
